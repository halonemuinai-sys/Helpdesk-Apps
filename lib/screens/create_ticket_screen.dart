  ...
  Future<void> _handleSubmit() async {
    ...
    if (_selectedRequester == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Silakan pilih karyawan pelapor (requester)!'), backgroundColor: Colors.redAccent),
      );
      return;
    }
    ...
    if (subCat == 'CUSTOM_ADD' || subCat.isEmpty) {
      ...
      if (subCat.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Sub-kategori detail wajib diisi!'), backgroundColor: Colors.redAccent),
        );
        return;
      }
    }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Tiket berhasil dibuat!'), backgroundColor: AppColors.emeraldDefault),
        );
          ...
          child: Column(
            ...
            children: [
              ...
              if (_selectedRequester == null) ...[
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Ketik nama / email / ID karyawan...',
              ...
              TextFormField(
                ...
                style: const TextStyle(color: Colors.white),
                decoration: InputDecoration(
                  hintText: 'Contoh: Email Outlook tidak bisa sinkron',
                  hintStyle: const TextStyle(color: Colors.white38, fontSize: 13),
                  filled: true,
                  fillColor: const Color(0xFF0F172A),
                  enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.slate900)),
                ...
                validator: (value) {
                  if (value == null || value.trim().isEmpty) return 'Judul tiket wajib diisi';
                  return null;
                },
              ),
              const SizedBox(height: 24),
              ...
              DropdownButtonFormField<String>(
                ...
                items: [
                  ...
                  const DropdownMenuItem<String>(
                    value: 'CUSTOM_ADD',
                    child: Text('+ Tambah Sub-Kategori Baru...', style: TextStyle(color: Color(0xFF818CF8), fontWeight: FontWeight.bold)),
                  ),
                ],
                onChanged: (val) {
                  setState(() {
              ...
              if (_selectedSubCategory == 'CUSTOM_ADD') ...[
                ...
                TextFormField(
                  ...
                  style: const TextStyle(color: Colors.white),
                  decoration: InputDecoration(
                    hintText: 'Tulis nama sub-kategori baru...',
                    hintStyle: const TextStyle(color: Colors.white38, fontSize: 13),
                    filled: true,
                    fillColor: const Color(0xFF0F172A),
                    enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.slate900)),
                  ...
                  validator: (value) {
                    if (_selectedSubCategory == 'CUSTOM_ADD' && (value == null || value.trim().isEmpty)) {
                      return 'Nama sub-kategori kustom wajib diisi';
                    }
                    return null;
                  },
                ),
              ...
              TextFormField(
                ...
                style: const TextStyle(color: Colors.white),
                decoration: InputDecoration(
                  hintText: 'Tuliskan deskripsi masalah/kendala IT secara terperinci...',
                  hintStyle: const TextStyle(color: Colors.white38, fontSize: 13),
                  filled: true,
                  fillColor: const Color(0xFF0F172A),
                  enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.slate900)),
