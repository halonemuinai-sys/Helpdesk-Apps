...
class _CreateTicketScreenState extends State<CreateTicketScreen> {
  ...
  Future<void> _handleSubmit() async {
    ...
    if (_selectedRequester == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Silakan pilih karyawan pelapor (requester)!'),
    ...
    if (subCat == 'CUSTOM_ADD' || subCat.isEmpty) {
      ...
      if (subCat.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Sub-kategori detail wajib diisi!'),
            backgroundColor: Colors.redAccent,
          ),
        );
        return;
  ...
  Widget build(BuildContext context) {
    ...
    if (_selectedSubCategory.isEmpty && filteredSubCategories.isNotEmpty) {
      ...
      _selectedSubCategory = filteredSubCategories.isNotEmpty
          ...
          child: Column(
            ...
            children: [
              ...
              if (_selectedRequester == null) ...[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white,
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(color: AppColors.green500.withOpacity(0.4)),
                  ),
                  child: Row(
                    children: [
                      CircleAvatar(
                        ...
                        child: Text(
                          (_selectedRequester!['name'] as String)
                              .substring(0, 1)
                              .toUpperCase(),
                          style: const TextStyle(
                            color: Colors.white,
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  hintText:
                      'Tuliskan deskripsi masalah/kendala IT secara terperinci...',
                  hintStyle: const TextStyle(
                    color: AppColors.slate400,
                    fontSize: 13,
                  ),
